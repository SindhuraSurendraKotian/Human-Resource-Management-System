 ...
 * 
 */
public class hrp1 extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel10.setBackground(new Color(51, 255, 102));
        ...
        jPanel1.setBackground(new Color(51, 204, 102));
        ...
        jLabel31.setText("WELCOME TO HR MANAGEMENT AND PAYROLL SERVICES");
        ...
        jLabel1.setText("HIRE DATE: (YYYY-MM-DD)");
        ...
        jLabel28.setText("HIRE DATE: (YYYY-MM-DD)");
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
       conn=Connect.ConnectDB();
        String Sql;
         Sql = "insert into employee (name,emp_id,gender,dob,contact_no,designation,department,hire_date,username) values (?,?,?,?,?,?,?,?,?)";
        try
        {
           ...
           // pst.setString(8,((JTextField)jDateChooser2.getDateEditor().getUiComponent()).getText());
            ...
            pst.execute();
            JOptionPane.showMessageDialog(null,"Password Generated for Employee!!!");
            JOptionPane.showMessageDialog(null,"Successfully entered details for Employee!!!" + ename.getText());
            
            String sql7="select * from employee where emp_id ='"+eid.getText()+"'";
            try
            {            
                pst=conn.prepareStatement(sql7);
